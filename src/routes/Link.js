...
// import { execOnce, formatWithValidation, getLocationOrigin } from '../next-server/lib/utils';
...
// let observer = window.IntersectionObserver;
...
// 		const props = ({ onMouseEnter, onClick, href, ref } = {
// 			ref: el => {
// 				this.handleRef(el);
